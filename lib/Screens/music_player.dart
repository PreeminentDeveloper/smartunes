...
class MusicPlayer extends StatefulWidget {
  ...
  // final RecommendedPlaylists music2;
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    Expanded(child: GestureDetector(
                      child: Icon(toggleSpeaker == 0 ? Icons.volume_down : Icons.volume_up, color: Colors.white, size: 26.0,),
                        onTap: (){
                    ...
                    Expanded(child: GestureDetector(
                      child: Icon(Icons.stop, color: Colors.white, size: 26.0),
